...
pkgver=0.7.9.4.17.14.
pkgrel=1
makedepends=("linux-vfio-headers=4.17.14." "spl-linux-vfio-headers")
arch=("x86_64")
...
license=("CDDL")
depends=("kmod" 'spl-linux-vfio' "zfs-utils-common=0.7.9" "linux-vfio=4.17.14.")
prepare() {
    cd "${srcdir}/zfs-0.7.9"
...
build() {
    ...
    ./configure --prefix=/usr --sysconfdir=/etc --sbindir=/usr/bin --libdir=/usr/lib \
                ...
                --with-linux=/usr/lib/modules/4.17.14.-vfio/build \
                --with-linux-obj=/usr/lib/modules/4.17.14.-vfio/build
    make
}
...
package_zfs-linux-vfio-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/zfs-*/4.17.14.-vfio/Module.symvers
}
