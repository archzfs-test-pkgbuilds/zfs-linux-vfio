...
pkgver=0.7.9.4.15.12.1
pkgrel=1
makedepends=("linux-vfio-headers=4.15.12-1" "spl-linux-vfio-headers")
arch=("x86_64")
...
license=("CDDL")
depends=("kmod" "spl-linux-vfio" "zfs-utils-common=0.7.9" "linux-vfio=4.15.12-1")
